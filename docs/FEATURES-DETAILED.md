...
> 本文档是 MarxSphere 的完整功能规格说明。所有功能均已在 Web 界面（48 视图）或桌面端实现并验证。
...
## 一、导航与工作区（48 视图 · 7 大分类）

### 导航结构（Mega Menu）

| 分类 | 视图 | 说明 |
|---|---|---|
| **对话推理** | AI对话 / MCP工具检索 / 推理工作台 / Ask检索 | AI 交互核心 |
| **科研中心** | 文献库 / 文献管理 / 外部检索 / 场景 / 教育 / 实证研究 / 结构解析 / 引文核验 / 格式智能评测 / PDF2Obsidian / 政经C刊科研 / 写作语料库 / 研途写作舱 / 课题流程编排 / 论文质量评审 / 成果可视化工坊 / 学术文本工作台 | 科研全流程 |
| **知识中心** | 知识页 / 记忆 / PG入库 / Graphiti入库 / Cognee入库 / 图谱 / 数据源 | 知识沉淀 |
| **政策资料** | 政策库 / 资料库 | 政策与资料 |
| **技能工具** | 技能 / MCP | 工具扩展 |
| **系统管理** | Jobs / 任务 / Agent控制台 / 记忆巩固 / Trace / 评测 / 告警 / IM接入 / Inbox / 账户计费 / 运营管理 / 文档中心 / 站点内容 / 历史记录 | 运维管理 |
...
## 四、AI Agent 子系统（50 通用工具 + 22 视图工具 · 122 教育路由 + 39 学习引擎顶层）
...
### 4.2 工具矩阵（72 工具 = 50 Agent 工具 + 22 视图；教育工具经 /api/education/* 122 路由 + 学习引擎顶层 39 路由接入）
...
## 九、AI+教育（顶部「AI+教育」Tab · 122 教育路由 + 39 学习引擎顶层）
