...
> 本文档是 MarxSphere 的完整功能规格说明。所有功能均已在 Web 界面（43 视图）或桌面端实现并验证。
...
## 四、AI Agent 子系统（48 通用工具 + 22 视图工具 · 112 教育路由 + 32 学习引擎顶层）
...
### 4.2 工具矩阵（70 工具 = 48 Agent 工具 + 22 视图；教育工具经 /api/education/* 112 路由 + 学习引擎顶层 32 路由接入）
