...
**规模**：284 服务文件（40 agent-* + 9 教育服务 + 9 学习引擎服务 + 工程纵深新增 cost-ledger/tier-router/b5 增强）· 918 路由（122 教育 + 39 学习引擎顶层 + 引文核验 + 成本/路由审计端点）· 153 迁移 · 48 前端视图 · 1080 测试(CI 全绿)
...
- Kappa 校准门 ≥0.7（当前 1.000）；1012 项单元测试

## 7. 基础设施

| 组件 | 说明 |
|---|---|
| 后端 | Fastify 5，4173，918 路由 |
