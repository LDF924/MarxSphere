...
5 分钟把 MarxSphere 推理/检索能力接入 Claude Code 或 Codex。
...
2. 点"新建令牌"，填写名称（如 `claude-code-prod`），勾选权限（推理/搜索/入库）
...
- [API 参考](api-reference.md) —— 底层 REST 接口
- [Cookbook](cookbook.md) —— 真实任务示例
- [Claude Code 集成](integrations/claude-code.md) / [Codex 集成](integrations/codex-cli.md)
