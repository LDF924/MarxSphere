      ...
      <div className="mx-auto w-full max-w-[1400px] space-y-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-background/60 to-violet-500/10 p-5">
          ...
          <div className="relative">
            ...
            <div className="mt-3 rounded-xl border border-white/10 bg-background/40 px-3 py-3">
              <div className="mb-2 text-[11px] font-medium text-foreground/90">📄 公文起草 — 按 GB/T 9704 规范起草通知/请示/报告/调研报告等 23 种文种</div>
              <ToolRunner
                tool="gongwen_draft"
                title="公文起草"
                fields={[
