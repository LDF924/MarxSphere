// universe-expansion-admission.test.ts — 扩展页准入单测(移植 Zleap universe-expansion-admission.test.ts)
import { describe, expect, it } from "vitest";

import type { UniverseGraphPatch, UniversePatchNode } from "./universe-types";
import {
