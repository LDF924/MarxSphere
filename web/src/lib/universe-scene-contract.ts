// universe-scene-contract.ts — 3D 场景契约:节点/边/数据/句柄/Props(对齐 Zleap universe-scene-contract.ts)
// 纯类型模块;UniverseScene 组件与 UniverseForceSceneEngine 共用此契约。
// 来源: Zleap-AI/SAG apps/web/components/features/universe-scene-contract.ts(完整移植)。
import type { SearchSourceHit, UniversePolicy } from "./universe-types";
import type { UniverseViewPreferences } from "./universe-view-preferences";
