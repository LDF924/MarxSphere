// universe-timeline-deque.ts — 原始时间轴缓存:定容双端队列(对齐 Zleap universe-timeline-deque.ts)
// 语义: 与渲染工作集相互独立;旧页追加并淘汰最新缘,新页前插并淘汰最旧缘;
// 每个保留下来的边界 bundle 携带重取已淘汰侧所需的不透明游标。
// 来源: Zleap-AI/SAG apps/web/lib/universe-timeline-deque.ts(完整移植)。
import type {
