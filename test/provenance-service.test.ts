...
import { fileHistory, queryProvenance, recordProvenance } from "../src/services/provenance-service.js";
beforeAll(async () => {
...
describe("recordProvenance", () => {
  ...
  it("带 runId 的记录采集环境快照(envHash + 内容寻址文件)", async () => {
    ...
    const { readEnvSnapshot } = await import("../src/services/provenance-service.js");
