...
> 📖 **完整功能规格**：见 [docs/FEATURES-DETAILED.md](docs/FEATURES-DETAILED.md)（52 步推理逐步表 / 66 场景清单 / 88 工具矩阵(66 Agent + 22 视图) / 17 实证功能 / 桌面端细节 / 评测指标）
...
- **88 工具自主调度**：66 个 Agent 工具（检索/推理/实证/写作/代码/联网/图片/文件/教育能力/格式评测/论文质量）+ 22 个视图工具（政策库/知识页/文献库/图谱/任务/评测/告警等，41 视图能力全覆盖）
...
### 🤖 AI Agent（50+ 能力项 · 88 工具 · 5 层安全 · 5 层记忆）
...
| 🤖 **AI Agent** | 88 工具自主调度（含 Notebook 图表模板/桌面控制/格式评测）/ 5 层安全 / 5 层记忆 / 任务 DAG / 审批门 |
