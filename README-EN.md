...
> 📖 **Full feature spec**: [docs/FEATURES-DETAILED.md](docs/FEATURES-DETAILED.md) (52-step reasoning walkthrough / 66 scenario catalog / 92-tool matrix (70 Agent + 22 view) / 17 empirical features / desktop details / eval metrics)
...
- **92-tool dispatch**: 70 Agent tools (search/reason/empirical/writing/code/web/image/file/education/format-eval/paper-quality) + 22 view tools (policy library / knowledge pages / literature / graph / tasks / eval / alerts, etc. — full 41-view coverage)
...
**② Tool Matrix (70 Agent tools; plus 22 view tools = 92)**
