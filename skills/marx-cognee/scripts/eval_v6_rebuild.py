"""
Cognee RAG v8 — capital_rebuild qwen3.7-max + include_references=True
"""
...
RESULTS = Path("eval/eval_results_v8_max_ref.json")
...
async def main():
    print("=" * 70)
    print("Cognee RAG v8 — qwen3.7-max + include_references")
    print("=" * 70)
    ...
    # ── 最终报告 ──
    print(f"\n{'='*70}")
    print(f"v6 评估完成 — capital_rebuild (208 papers, 63,636 edges)")
    print(f"{'='*70}")
