...
_LOG_DIR = _PIPELINE_ROOT / ".mcp_logs"
    ...
    return {
        ...
        "checklist": [
            ...
            },
            {
                "phase": 1,
                "name": "MD 完整性检测",
                "command": "cd D:\\Desktop\\执行流程 && python check_md_files.py --json",
            ...
            },
            {
                "phase": 2,
                "name": "环境与成本确认",
                "command": "cd D:\\Desktop\\执行流程 && python module1_env_check.py --all",
            ...
            },
            {
                ...
                "command": "cd D:\\Desktop\\执行流程 && python robust_pipeline_v3.py",
            ...
            },
            {
                "phase": 4,
                "name": "知识蒸馏",
                "command": "cd D:\\Desktop\\执行流程 && python distill_robust.py",
                "verification": "check_pipeline_progress",
            ...
            },
            {
                "phase": 5,
                "name": "向量化",
                "command": "cd D:\\Desktop\\执行流程 && python run_module3.py",
                "verification": "check_pipeline_progress",
            ...
            },
            {
                "phase": 6,
                "name": "全局消歧聚类清洗",
                "command": "cd D:\\Desktop\\执行流程 && python 全局消歧聚类清洗.py",
            ...
            },
            {
                "phase": 7,
                "name": "备份",
                "command": "cd D:\\Desktop\\执行流程 && python neo4j_rollback.py --list  # 先看现有备份\npython module1_env_check.py --all  # module1 会自动创建备份",
